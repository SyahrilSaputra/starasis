        ...
        <div class="row">
          ...
          <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>Daftar_Aplikasi/save" enctype="multipart/form-data" method="post">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="number" class="form-control" name="urutan" value="<?php echo $judul_pengumuman; ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <select class="form-control" name="jenis_link">
                        <option value="internal">Internal (cont. controller/method)</option>
                        <option value="eksternal">Eksternal (cont. https://www.kemdikbud.go.id/ atau ../kesiswaan)</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                      <input type="text" class="form-control" name="link" value="<?php echo $judul_pengumuman; ?>" required>
                    </div>
                  </div>
