        ...
        <div class="animated fadeInLeft col-md-8">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-key"></i> Input <?php echo $judul; ?></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

            <?php foreach($data_password as $f): ?>
              <form class="form-horizontal" role="form" action="<?php echo base_url('User/siswa_edit_password/').$f->id_siswa; ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="nis" value="<?= $f->nis ?>" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Password saat ini</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="password" value="<?= $f->password ?>" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Nisn</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="nisn" value="<?= $f->nisn ?>" required>
                    </div>
                  </div>
                <?php endforeach ?>
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>User/guru"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
