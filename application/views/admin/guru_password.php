      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInLeft col-md-8">
            ...
            <?php foreach($data_password as $f): ?>
              <form class="form-horizontal" role="form" action="<?php echo base_url('User/guru_edit_password/').$f->id_guru; ?>" method="post">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="nip" value="<?= $f->nip ?>" required>
                    </div>
                  </div>
                  <div class="form-group row">
