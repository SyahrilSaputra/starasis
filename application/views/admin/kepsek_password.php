      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInLeft col-md-8">
            ...
            <?php foreach($data_password as $f): ?>
              <form class="form-horizontal" role="form" action="<?php echo base_url('User/kepsek_edit_password/').$f->id_kepala_sekolah; ?>" method="post">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>User/kepsek"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
