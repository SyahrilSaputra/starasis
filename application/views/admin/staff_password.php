      ...
      <div class="container-fluid">
        ...
        <div class="animated fadeInLeft col-md-8">
            ...
            <?php foreach($data_password as $f): ?>
              <form class="form-horizontal" role="form" action="<?php echo base_url('User/staff_edit_password/').$f->id_staff; ?>" method="post">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-danger float-right" href="<?php echo base_url(); ?>User/staff"><i class="fa fa-undo"> </i> Kembali</a>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
