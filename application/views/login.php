...
<head>
  ...
  <title>SIAKAD | Sistem Informasi Akademik Madrasah</title>
    ...
    <div id="app" class="app ">
      <div class="login-wrapper">
        <div class="bg-pic animated fadeInLeft" >
          <img width="100%" src="<?php echo base_url(); ?>assets/dist/img/bgg.jpg">  
        ...
        <div class="login-container white animated fadeInDown" style="min-height: 00px;">
          ...
          <div class=" p-x-md m-t-lg"><br>
            <div class="text-center p-x-sm">
              <img src="<?php echo 'http://'.$_SERVER['SERVER_NAME'].'/../asispanel/upload/'.$sekolah->logo; ?>" height='100px' class="apps "> <br><br>
              <b><h3>LOGIN AKADEMIK</h3></b>
            </div> 
            ...
            <form action="<?php echo base_url(); ?>login/cek" method='post' class="ogin100-form validate-form  ">
              ...
              <div class="md-form-group 1"><b>Password</b>
                ...
                <input placeholder="text" type="hidden" name="type" value="" class="md-input p-l-1"> 
